          ...
          <div className="space-y-1">
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  <span className={`${isActive ? 'text-primary-600' : 'text-gray-400 group-hover:text-gray-500'} mr-3`}>
                    {item.icon}
                  </span>
                  {item.name}
                </Link>
            ...
            <div className="flex-1 flex">
              <div className="w-full flex md:ml-0">
                ...
                <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                  ...
                  <input
                    id="search-field"
                    className="block w-full h-full pl-8 pr-3 py-2 border-transparent text-gray-900 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent bg-transparent dark:text-white dark:placeholder-gray-400"
                    placeholder="Search..."
                    type="search"
                  />
                </div>
